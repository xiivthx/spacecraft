---
description: Run systematic research via spacecraft research CLI (Brave Search, scoped docs, deep analysis)
agent: sc-commander
subtask: true
---
...
```
scripts/spacecraft research "test" --json --no-save 2>&1
```
...
```
scripts/spacecraft research "<query>" [user-provided flags]
```
...
```
scripts/spacecraft evidence "research-<query-slug>" -- spacecraft research "<query>" [flags]
```
