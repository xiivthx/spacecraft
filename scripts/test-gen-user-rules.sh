...
#
# Runs the generator over the five alwaysApply rule sources
# (000/025/050/100/200) and asserts:
#   1. output body contains marker text from all five sources
...
# --- Acceptance 1: marker text from all five sources present in the body ---
missing=0
for marker in 'Spacecraft' 'English prompt coach' 'Coding Standards' 'Project Structure' 'Lane Detection'; do
...
echo "  ok   output body contains all five source markers"
