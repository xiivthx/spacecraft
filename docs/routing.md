...
| sc-clarify | `.opencode/skills/sc-clarify/` | /sc-start, /sc-clarify, /sc-design, /sc-plan, /sc-build |
...
| sc-verification | `.opencode/skills/sc-verification/` | /sc-build, /sc-review, /sc-ship |
