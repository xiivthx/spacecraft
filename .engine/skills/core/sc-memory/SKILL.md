...
name: sc-memory
description: >
  Wraps ctx_search and ctx_index with spacecraft conventions for structured memory across missions.
  Activate on cross-mission recall, lesson lookup, session context recovery, or "memory", "what do we know about",
  "prior mission context", "search memory", "recall".
license: MIT
