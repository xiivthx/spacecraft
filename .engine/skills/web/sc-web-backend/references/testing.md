...
- Run tests per endpoint: `scripts/spacecraft evidence "<endpoint>:test" -- npx vitest run src/routes/<name>.test.ts`
- Full suite: `scripts/spacecraft evidence "<task>-functional" -- npm test`
