...
6. **Verify** — `scripts/spacecraft evidence "<label>" -- echo "Architecture decision documented"`. ADRs and diagrams are manual artifacts. Evidence is the existence of the documented decision.
...
- **Must**: Resolve mission with `scripts/spacecraft resolve --json` before documenting architecture.
