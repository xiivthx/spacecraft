...
6. **Verify** — `scripts/spacecraft evidence "<label>" -- <migration-test-command>`. Migrations must apply cleanly and roll back cleanly. Query tests must demonstrate index usage (`EXPLAIN ANALYZE`).
