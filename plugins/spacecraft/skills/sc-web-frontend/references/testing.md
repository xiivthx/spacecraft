...
- Run tests per slice: `spacecraft evidence "<slice>:test" -- npx vitest run src/components/<name>.test.tsx`
- Full suite after refactor: `spacecraft evidence "<task>-functional" -- npx vitest run`
