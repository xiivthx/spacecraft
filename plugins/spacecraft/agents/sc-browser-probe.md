...
description: Live browser probe (Chrome DevTools MCP / browser automation) + AFK fix-loop. Use after UI/workflow build or when asked to browser-test. Sweep Foundations and matched packs; fix every finding via Task(sc-coder/sc-tester) until CLEAN or 3-cycle.
---
