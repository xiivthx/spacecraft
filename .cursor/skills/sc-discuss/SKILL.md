...
2. **Surface checklist:** Match the primary surface to `sc-ux-design/references/surface-checklist.md`. Record `UX checklist: <id>` or `UX checklist: none - <reason>` in `decisions.md` before bake-off. Fold applicable house items into `spec.md` Must and the approval draft. Do not copy external checklist text.
...
| Surface checklist | `sc-ux-design/references/surface-checklist.md` |
