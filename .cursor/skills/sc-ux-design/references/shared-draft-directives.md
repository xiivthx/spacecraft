...
- Treat the approved **design brief** and any user-supplied copy, names, and constraints as source of truth. Do not invent product claims, metrics, schedules, or brand lines the brief did not supply.
...
- Drafts are throwaway mockups for look-and-structure judgment - not production implementation sources.
