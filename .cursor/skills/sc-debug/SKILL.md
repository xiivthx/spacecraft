---
name: sc-debug
description: "Diagnoses bugs with five-step discipline when behavior is reproducible or evidence can be captured."
...
Delegate test creation and reproduction verification to `/sc-tester`. Delegate production fixes to `/sc-coder` only after the root cause is proven.
