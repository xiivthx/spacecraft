...
Live multi-pack adapter for `/sc-browser-probe`. Item SoT: `.cursor/skills/sc-ux-design/references/checklists/` (index: `README.md` there). Foundations stay in `dimensions.md`.
