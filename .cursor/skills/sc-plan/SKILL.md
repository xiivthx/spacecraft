---
name: sc-plan
description: "Creates or updates a mission plan when the specification is resolved and implementation must be decomposed."
...
1. Invoke /sc-planner as a read-only subagent to draft the plan. 
